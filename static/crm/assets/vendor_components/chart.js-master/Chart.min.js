            ...
            e.exports = function (t) {
                ...
                t.defaults.line = {
                    ...
                    updateBezierControlPoints: function () {
                        ...
                        var e, i, n, o, r, l = this, s = l.getMeta(), d = l.chart.chartArea,
                            ...
                            var b = n.boxWidth, v = a.legendHitBoxes, x = function (e, a, n) {
                                if (!(isNaN(b) || 0 >= b)) {
                                    if (u.save(), u.fillStyle = c(n.fillStyle, o.defaultColor), u.lineCap = c(n.lineCap, r.borderCapStyle), u.lineDashOffset = c(n.lineDashOffset, r.borderDashOffset), u.lineJoin = c(n.lineJoin, r.borderJoinStyle), u.lineWidth = c(n.lineWidth, r.borderWidth), u.strokeStyle = c(n.strokeStyle, o.defaultColor), u.setLineDash && u.setLineDash(c(n.lineDash, r.borderDash)), i.labels && i.labels.usePointStyle) {
                                        var l = f * Math.SQRT2 / 2, s = l / Math.SQRT2, d = e + s, h = a + s;
                ...
                t.defaults.scale = {
                    ...
                    fit: function () {
                        var a = this, i = a.minSize = {width: 0, height: 0}, n = a.options, o = t.defaults.global,
                            r = n.ticks, l = n.scaleLabel, s = n.display, d = a.isHorizontal(),
                            u = e.getValueOrDefault(r.fontSize, o.defaultFontSize),
                            c = e.getValueOrDefault(r.fontStyle, o.defaultFontStyle),
                            h = e.getValueOrDefault(r.fontFamily, o.defaultFontFamily), f = e.fontString(u, c, h),
                            g = e.getValueOrDefault(l.fontSize, o.defaultFontSize), p = n.gridLines.tickMarkLength;
                        if (d ? i.width = a.isFullWidth() ? a.maxWidth - a.margins.left - a.margins.right : a.maxWidth : i.width = s ? p : 0, d ? i.height = s ? p : 0 : i.height = a.maxHeight, l.display && s && (d ? i.height += 1.5 * g : i.width += 1.5 * g), r.display && s) {
                            ...
                            var m = e.longestText(a.ctx, f, a.ticks, a.longestTextCache),
                                b = e.numberOfLabelLines(a.ticks), v = .5 * u;
                            if (d) {
                                ...
                                var C = a.maxWidth - i.width, M = r.mirror;
                    ...
                    draw: function (a) {
                        ...
                        if (n.display) {
                            ...
                            var p = e.getValueOrDefault(d.fontColor, s.defaultFontColor),
                                ...
                                y = u.tickMarkLength, k = e.getValueOrDefault(c.fontColor, s.defaultFontColor),
                                S = e.getValueOrDefault(c.fontSize, s.defaultFontSize),
                                w = e.getValueOrDefault(c.fontStyle, s.defaultFontStyle),
                                C = e.getValueOrDefault(c.fontFamily, s.defaultFontFamily), M = e.fontString(S, w, C),
                                D = e.toRadians(i.labelRotation), A = Math.cos(D), I = i.longestLabelWidth * A;
                            l.fillStyle = p;
                            var T = [];
                            if (g) {
                            ...
                            if (e.each(i.ticks, function (t, r) {
                                ...
                                var V, L, O = 0;
                                if (g) V = i.left + (i.right - i.left) / 2, L = "bottom" === n.position ? i.bottom - S / 2 : i.top + S / 2; else {
                            ...
                            if (u.drawBorder) {
                                ...
                                var W = i.left, z = i.right, N = i.top, H = i.bottom, E = e.aliasPixel(l.lineWidth);
            ...
            e.exports = function (t) {
                var e = t.helpers, a = {
                    ...
                    determineDataLimits: function () {
                        ...
                        var a, i, n = this, o = n.start, r = +n.getRightValue(t), l = e.log10(n.end) - e.log10(o),
                            s = n.paddingTop, d = n.paddingBottom, u = n.paddingLeft;
            ...
            i = "function" == typeof i ? i : window.moment, e.exports = function (t) {
                var e = t.helpers, a = {
                    ...
                    initialize: function () {
                        ...
                        if (o) {
                            var r = o.diff(n.firstTick, n.tickUnit, !0), l = 0 !== r ? r / n.scaleSizeInUnits : r;
                            if (n.isHorizontal()) {
                                var s = n.width - (n.paddingLeft + n.paddingRight), d = s * l + n.paddingLeft;
                                return n.left + Math.round(d)
                            }
                            var u = n.height - (n.paddingTop + n.paddingBottom), c = u * l + n.paddingTop;
