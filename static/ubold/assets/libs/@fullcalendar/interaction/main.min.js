...
!function (e, t) {
    ...
    var o = 0, a = 0, l = !1, s = function () {
        ...
        return e.prototype.destroy = function () {
            this.containerEl.removeEventListener("mousedown", this.handleMouseDown), this.containerEl.removeEventListener("touchstart", this.handleTouchStart, {passive: !0}), --a || window.removeEventListener("touchmove", c, {passive: !1})
        }, e.prototype.tryStart = function (e) {
            var n = this.querySubjectEl(e), r = e.target;
    ...
    var d = function () {
        ...
        return e.prototype.start = function (e, t, n) {
            ...
            var r = this.mirrorEl, i = this.sourceEl.getBoundingClientRect();
            ...
            var e = this.sourceElRect, n = this.mirrorEl;
    ...
    }(t.ScrollController), u = function (e) {
        function n(n, r) {
    ...
    }(g), p = "function" == typeof performance ? performance.now : Date.now, v = function () {
        function e() {
            var e = this;
        ...
        return e.prototype.start = function (e, t) {
            ...
            for (var n = this.edgeThreshold, r = null, i = 0, o = this.scrollCaches; i < o.length; i++) {
                var a = o[i], l = a.clientRect, s = e - l.left, c = l.right - e, d = t - l.top, g = l.bottom - t;
            ...
            r.delay = null, r.minDistance = 0, r.touchScrollAllowed = !0, r.mirrorNeedsRevert = !1, r.isInteracting = !1, r.isDragging = !1, r.isDelayEnded = !1, r.isDistanceSurpassed = !1, r.delayTimeoutId = null, r.onPointerDown = function (e) {
                ...
                if (r.isInteracting) {
                    if (r.emitter.trigger("pointermove", e), !r.isDistanceSurpassed) {
                        var t = r.minDistance, n = e.deltaX, i = e.deltaY;
    ...
    var m = function () {
        ...
        return e.prototype.processFirstCoord = function (e) {
            var n, r = {left: e.pageX, top: e.pageY}, i = r, o = e.subjectEl;
            ...
            var r = this.droppableStore, i = this.offsetTrackers, o = null;
            for (var a in r) {
                var l = r[a].component, s = i[a];
                if (s.isWithinClipping(e, n)) {
                    var c = s.computeLeft(), d = s.computeTop(), g = e - c, u = n - d, h = s.origRect,
                        p = h.right - h.left, v = h.bottom - h.top;
                    if (g >= 0 && g < p && u >= 0 && u < v) {
    ...
    var y = function (e) {
        function n(n) {
            ...
            r.handlePointerDown = function (e) {
                ...
                var t = r.component.context, n = t.calendar, i = t.view;
                if (!r.dragging.pointer.wasTouchScroll) {
                    var o = r.hitDragging, a = o.initialHit, l = o.finalHit;
    ...
    }(t.Interaction), D = function (e) {
        function n(n) {
            var r = e.call(this, n) || this;
            r.dragSelection = null, r.handlePointerDown = function (e) {
                var t = r, n = t.component, i = t.dragging,
                ...
                var o = r.component.context.calendar, a = null, l = !1;
                e && ((a = function (e, n, r) {
                    var o = e.dateSpan, a = n.dateSpan, l = [o.range.start, o.range.end, a.range.start, a.range.end];
                    ...
                    type: "SELECT_DATES",
                    selection: a
                }) : n || o.dispatch({type: "UNSELECT_DATES"}), l ? t.disableCursor() : t.enableCursor(), n || (r.dragSelection = a)
            ...
            var o = n.component, a = o.context.options, l = r.dragging = new f(o.el);
    ...
    var w = function (e) {
        function n(r) {
            ...
            o.subjectSeg = null, o.isDragging = !1, o.eventRange = null, o.relevantEvents = null, o.receivingCalendar = null, o.validMutation = null, o.mutatedRelevantEvents = null, o.handlePointerDown = function (e) {
                var n = e.origEvent.target, r = o, i = r.component, a = r.dragging, l = a.mirror, s = i.context.options,
                    c = i.context.calendar, d = o.subjectSeg = t.getElSeg(e.subjectEl),
                ...
                var n = o.component.context, r = n.calendar, i = o.eventRange, a = i.instance.instanceId;
                e.isTouch ? a !== o.component.props.eventSelection && r.dispatch({
                    type: "SELECT_EVENT",
                    eventInstanceId: a
                }) : r.dispatch({type: "UNSELECT_EVENT"}), o.isDragging && (r.unselect(e), r.publiclyTrigger("eventDragStart", [{
                    el: o.subjectSeg.el,
                ...
                if (o.isDragging) {
                    var r = o.relevantEvents, i = o.hitDragging.initialHit, a = o.component.context.calendar, l = null,
                        s = null, c = null, d = !1, g = {
                            affectedEvents: r,
                ...
                if (o.isDragging) {
                    var n = o.component.context, r = n.calendar, a = n.view, l = o, s = l.receivingCalendar,
                        c = l.validMutation, d = o.eventRange.def, g = o.eventRange.instance,
                        u = new t.EventApi(r, d, g), h = o.relevantEvents, p = o.mutatedRelevantEvents,
            ...
            var a = o.component, l = a.context.options, s = o.dragging = new f(a.el);
        ...
        return r(n, e), n.prototype.destroy = function () {
            ...
            var r = this.component.context.calendar, i = this.receivingCalendar;
            ...
            var e = this.component.context.calendar, t = this.receivingCalendar;
    ...
    var T = function (e) {
        function n(n) {
            ...
            r.draggingSeg = null, r.eventRange = null, r.relevantEvents = null, r.validMutation = null, r.mutatedRelevantEvents = null, r.handlePointerDown = function (e) {
                var t = r.component, n = r.querySeg(e), i = r.eventRange = n.eventRange;
                ...
                var n = r.component.context, i = n.calendar, o = n.view, a = r.eventRange;
                ...
                var a = r.component.context.calendar, l = r.relevantEvents, s = r.hitDragging.initialHit,
                    c = r.eventRange.instance, d = null, g = null, u = !1, h = {
                        affectedEvents: l,
                        mutatedEvents: t.createEmptyEventStore(),
                        isEvent: !0,
                ...
                e && (d = function (e, n, r, o, a) {
                    ...
                    state: h
                }) : a.dispatch({type: "UNSET_EVENT_RESIZE"}), u ? t.disableCursor() : t.enableCursor(), n || (d && S(s, e) && (d = null), r.validMutation = d, r.mutatedRelevantEvents = g)
            }, r.handleDragEnd = function (e) {
                var n = r.component.context, i = n.calendar, o = n.view, a = r.eventRange.def,
                    l = r.eventRange.instance, s = new t.EventApi(i, a, l), c = r.relevantEvents,
            ...
            var o = n.component, a = r.dragging = new f(o.el);
    ...
    var M = function () {
        function e(e) {
            ...
            this.isRecentPointerDateSelect = !1, this.onSelect = function (e) {
                ...
                var r = n, i = r.calendar, o = r.documentPointer, a = i.state;
                if (!o.wasTouchScroll) {
                    if (a.dateSelection && !n.isRecentPointerDateSelect) {
                        var l = i.viewOpt("unselectAuto"), s = i.viewOpt("unselectCancel");
        ...
        function e(e, n) {
            ...
            this.receivingCalendar = null, this.droppableEvent = null, this.suppliedDragMeta = null, this.dragMeta = null, this.handleDragStart = function (e) {
                ...
                var a = r.hitDragging.dragging, l = null, s = null, c = !1, d = {
                ...
                var n = r, o = n.receivingCalendar, a = n.droppableEvent;
                if (r.clearDrag(), o && a) {
                    var l = r.hitDragging.finalHit, s = l.component.context.view, c = r.dragMeta,
    ...
    var C = function () {
        function e(e, n) {
            ...
            void 0 === n && (n = {}), this.handlePointerDown = function (e) {
                var n = r.dragging, i = r.settings, o = i.minDistance, a = i.longPressDelay;
