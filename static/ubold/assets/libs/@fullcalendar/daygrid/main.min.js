...
!function (e, t) {
    ...
    var i = function () {
    ...
    }(t.DateProfileGenerator), s = function () {
        function e(e) {
            var t = this;
        ...
        return n(r, e), r.prototype.renderSegHtml = function (e, r) {
            var n, i, o = this.context, s = e.eventRange, l = s.def, a = s.ui, d = l.allDay,
    ...
    }(t.FgEventRenderer), a = function (e) {
        function r(t) {
        ...
        return n(r, e), r.prototype.attachSegs = function (e, t) {
            ...
            var n, i, o, s, l, a, d, c = this.context.isRtl, h = this.dayGrid, p = h.colCnt, u = this.buildSegLevels(r),
                f = Math.max(1, u.length), m = document.createElement("tbody"), g = [], y = [], v = [];
            ...
            for (n = 0; n < f; n++) {
                if (i = u[n], o = 0, s = document.createElement("tr"), g.push([]), y.push([]), v.push([]), i) for (l = 0; l < i.length; l++) {
                    a = i[l];
                    var S = c ? p - 1 - a.lastCol : a.firstCol, w = c ? p - 1 - a.firstCol : a.lastCol;
            ...
            var t, r, n, i = this.context.isRtl, o = this.dayGrid.colCnt, s = [];
    ...
    var h = function (e) {
        ...
        return n(r, e), r.prototype.renderSegs = function (t, r, n) {
            ...
            var n, i, o, s = this.dayGrid, l = this.context.isRtl, a = s.colCnt, d = l ? a - 1 - r.lastCol : r.firstCol,
    ...
    }(t.FillRenderer), u = function (e) {
        function r(r) {
            var n = e.call(this, r) || this, i = n.eventRenderer = new f(n),
        ...
        return n(r, e), r.prototype.firstContext = function (e) {
            ...
            var r = this.context, n = r.theme, i = r.dateEnv, o = r.options,
    ...
    var y = t.createFormatter({day: "numeric"}), v = t.createFormatter({week: "numeric"}), b = function (e) {
        function r(r, n) {
            var i = e.call(this, r) || this;
            i.bottomCoordPadding = 0, i.isCellSizesDirty = !1, i.renderProps = n;
            var o = i.eventRenderer = new a(i), s = i.fillRenderer = new p(i);
        ...
        return n(r, e), r.prototype.render = function (e, t) {
            ...
            var n, i, o = this.context, s = o.calendar, l = o.view, a = o.isRtl, d = o.dateEnv, c = this.rowCnt,
                h = this.colCnt, p = "";
            ...
            var r = this.context.theme, n = ["fc-row", "fc-week", r.getClass("dayRow")];
            t && n.push("fc-rigid");
            ...
            var t = this.context.isRtl, r = this.renderProps.renderNumberIntroHtml(e, this);
            ...
            var r = this.colPositions, n = this.rowPositions, i = r.leftToIndex(e), o = n.topToIndex(t);
            ...
            for (r = 0; r < o.length; r++) if ((n = o[r]).classList.remove("fc-limited"), n.getBoundingClientRect().bottom > i) return r;
            return !1
        }, r.prototype.limitRow = function (e, r) {
            var n, i, o, s, l, a, d, c, h, p, u, f, m, g, y, v = this, b = this.colCnt, S = this.context.isRtl,
                w = this.eventRenderer.rowStructs[e], C = [], E = 0, R = function (n) {
            ...
            if (r && r < w.segLevels.length) {
                for (n = w.segLevels[r - 1], i = w.cellMatrix, (o = t.findChildren(w.tbodyEl).slice(r)).forEach(function (e) {
                    ...
                    l = n[s];
                    var H = S ? b - 1 - l.lastCol : l.firstCol, k = S ? b - 1 - l.firstCol : l.lastCol;
            ...
            var i = this, o = this.context, s = o.calendar, l = o.view, a = o.dateEnv, d = o.options, c = o.isRtl,
            ...
            return h.innerText = this.getMoreLinkText(n.length), h.addEventListener("click", function (t) {
                var o = d.eventLimitClick, h = c ? i.colCnt - r - 1 : r, p = i.props.cells[e][h].date,
                    u = t.currentTarget, f = i.getCellEl(e, r), m = i.getCellSegs(e, r), g = i.resliceDaySegs(m, p),
            ...
            var o, l, a = this, d = this.context, c = d.calendar, h = d.view, p = d.theme, f = d.isRtl,
                m = f ? this.colCnt - r - 1 : r, g = n.parentNode;
            ...
            for (var n = r, o = {start: n, end: t.addDays(n, 1)}, s = [], l = 0, a = e; l < a.length; l++) {
                var d = a[l], c = d.eventRange, h = c.range, p = t.intersectRanges(h, o);
                p && s.push(i({}, d, {
                    eventRange: {
                        def: c.def,
    ...
    }(t.DateComponent), S = t.createFormatter({week: "numeric"}), w = function (e) {
        function r() {
            ...
            return r.processOptions = t.memoize(r._processOptions), r.renderSkeleton = t.memoizeRendering(r._renderSkeleton, r._unrenderSkeleton), r.renderHeadIntroHtml = function () {
                var e = r.context, n = e.theme, i = e.options;
                ...
                var i = r.context, o = i.options, s = i.dateEnv, l = n.props.cells[e][0].date;
        ...
        return n(r, e), r.prototype._processOptions = function (e) {
            ...
            var i, o, s = this.dayGrid, l = this.context.options.eventLimit, a = this.header ? this.header.el : null;
    ...
    var C = function (e) {
        ...
        return n(t, e), t.prototype.firstContext = function (e) {
            ...
            var r = this.dayGrid, n = e.dateProfile, o = e.dayTable;
        ...
        return n(r, e), r.prototype.render = function (t, r) {
            ...
            var n = this.props.dateProfile, i = this.dayTable = this.buildDayTable(n, t.dateProfileGenerator);
