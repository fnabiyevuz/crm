...
!function (e, t) {
        ...
        return void 0 === n && (n = {}), !(e.eventDrag && !function (e, t, n, r) {
            ...
            for (var p in s) {
                ...
                for (var D = t.state.eventStore, T = 0, w = g.allows; T < w.length; T++) {
                    var R = w[T], C = Se({}, n, {range: h.range, allDay: y.allDay}), I = D.defs[y.defId],
                        M = D.instances[p], k = void 0;
                    if (k = I ? new ct(t, I, M) : new ct(t, y), !R(t.buildDateSpanApi(C), k)) return !1
                }
            }
            return !0
    ...
    var pn = 0, hn = function () {
        ...
        return e.addEqualityFuncs = function (e) {
            ...
            }(this.props || {}, e, this.equalityFuncs), i = r.anyChanges, o = r.comboProps;
            this.props = o, i && (n && this.beforeUpdate(), this.render(o, t), n && this.afterUpdate())
    ...
    e.Calendar = Cr, e.Component = vn, e.ComponentContext = hn, e.DateComponent = gn, e.DateEnv = Fn, e.DateProfileGenerator = $n, e.DayHeader = Zr, e.DaySeries = jr, e.DayTable = Yr, e.ElementDragging = Lr, e.ElementScrollController = ln, e.EmitterMixin = rn, e.EventApi = ct, e.FgEventRenderer = Nr, e.FillRenderer = Ur, e.Interaction = br, e.Mixin = nn, e.NamedTimeZoneImpl = zr, e.PositionCache = sn, e.ScrollComponent = dn, e.ScrollController = un, e.Slicer = qr, e.Splitter = Kt, e.Theme = fn, e.View = xr, e.WindowScrollController = cn, e.addDays = x, e.addDurations = function (e, t) {
        ...
        for (var r = e.calendar, i = e.view, o = r.pluginSystem.hooks.isDraggableTransformers, a = n.startEditable, s = 0, u = o; s < u.length; s++) a = (0, u[s])(a, t, n, i);
        return a
    ...
    },e.undistributeHeight = re,e.unpromisify = tn,e.version = "4.4.0",e.whenTransitionDone = function (e, t) {
        var n = function (r) {
