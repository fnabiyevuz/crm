!function (e, t) {
    ...
    function ut(t) {
        ...
        if (void 0 === it[t] && "undefined" != typeof module && module && module.exports) try {
            e = nt._abbr, require(__dirname + "/locale/" + t), lt(e)
        } catch (e) {
            it[t] = null
        }
        return it[t]
    ...
    pn.add = Jt, pn.calendar = function (e, t) {
        1 === arguments.length && (Kt(arguments[0]) ? (e = arguments[0], t = void 0) : function (e) {
            var t, n = u(e) && !l(e), s = !1, i = ["sameDay", "nextDay", "lastDay", "nextWeek", "lastWeek", "sameElse"];
    ...
    }, null != Symbol.for && (pn[Symbol.for("nodejs.util.inspect.custom")] = function () {
    ...
    return es.isValid = function () {
        ...
        n._d = new Date(Z(e))
    }), f.version = "2.25.0", e = Tt, f.fn = pn, f.min = function () {
